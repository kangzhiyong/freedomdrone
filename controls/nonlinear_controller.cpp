...
float NonlinearController::altitude_control(float altitude_cmd, float vertical_velocity_cmd, float altitude, float vertical_velocity, point3D attitude, float acceleration_ff)
{
...
point2D NonlinearController::roll_pitch_controller(point2D acceleration_cmd, point3D attitude, float thrust_cmd)
{
