...
public:
    ...
    V3F local_position_target();
    void set_local_position_target(V3F target);
    V3F local_velocity_target();
    void set_local_velocity_target(V3F target);
    V3F local_acceleration_target();
    void set_local_acceleration_target(V3F target);
    V3F attitude_target();
    void set_attitude_target(V3F target);
    V3F body_rate_target();
    void set_body_rate_target(V3F target);
