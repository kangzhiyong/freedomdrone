...
typedef enum UAVCAN_NODE_HEALTH
{
   ...
   UAVCAN_NODE_HEALTH_MERROR=2, /* The node has encountered a major failure. | */
...
typedef enum MAV_MISSION_RESULT
{
   ...
   MAV_MISSION_MERROR=1, /* Generic error / not accepting mission commands at all right now. | */
...
typedef enum MAV_SEVERITY
{
   ...
   MAV_SEVERITY_MERROR=3, /* Indicates an error in secondary/redundant systems. | */
...
typedef enum ESTIMATOR_STATUS_FLAGS
{
   ...
   ESTIMATOR_ACCEL_MERROR=2048, /* True if the EKF has detected bad accelerometer data | */
