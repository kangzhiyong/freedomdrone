...
enum class UAVCAN_NODE_HEALTH : uint8_t
{
    ...
    MERROR=2, /* The node has encountered a major failure. | */
...
enum class MAV_MISSION_RESULT : uint8_t
{
    ...
    MERROR=1, /* Generic error / not accepting mission commands at all right now. | */
...
enum class MAV_SEVERITY : uint8_t
{
    ...
    MERROR=3, /* Indicates an error in secondary/redundant systems. | */
...
enum class ESTIMATOR_STATUS_FLAGS : uint16_t
{
    ...
    ACCEL_MERROR=2048, /* True if the EKF has detected bad accelerometer data | */
};
